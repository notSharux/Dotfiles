...
colors = [["#181c40", "#181c40"], # panel background
          ["#3d3f4b", "#434758"], # background for current screen tab
          ["#ffffff", "#ffffff"], # font color for group names
          ["#ff5555", "#ff5555"], # border line color for current tab
          ["#181c40", "#181c40"], # border line color for 'other tabs' and color for 'odd widgets'      #161f59
          ["#0860f2", "#0860f2"], # color for the 'even widgets'
